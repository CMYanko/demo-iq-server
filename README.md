...
```
For PoC's and or custom config'd demo environments you'll likely want your own tag and publish to a private repo. Making modification to the config.yml before the build will get them copied into you custome container. Usefule for setting up proxy servers, email notifications or integrating with JIRA.
